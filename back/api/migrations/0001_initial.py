...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('client_id', models.CharField(db_index=True, default=uuid.uuid4, max_length=36, unique=True)),
                ...
                ('scope', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=24), null=True, size=None)),
                ('response_type', models.TextField(null=True)),
                ('grant_type', models.TextField(choices=[('authorization_code', 'authorization_code')], default='authorization_code')),
